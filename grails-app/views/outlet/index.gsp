                        ...
                        <table class="table table-bordered fadeIn second">
                            ...
                            <g:each in="${outletList}" var="info">
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <g:link controller="outlet" action="details" class="btn btn-secondary" id="${info.id}"><i class="fas fa-eye"></i></g:link>
                                            <g:link controller="outlet" action="edit" class="btn btn-secondary" id="${info.id}"><i class="fas fa-edit"></i></g:link>
                                            <g:link controller="outlet" action="delete" id="${info.id}" class="btn btn-secondary delete-confirmation"><i class="fas fa-trash"></i></g:link>
                                        </div>
                                    </td>
                                </tr>
                            </g:each>
